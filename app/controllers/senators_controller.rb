class SenatorsController < ApplicationController
  ...
  # GET /senators.json
  def index
    @senators = Senator.order('created_at DESC') #sort alphabeltically instead
  end
  ...
  def create
    ...
    respond_to do |format|
      if @senator.save
        format.html { redirect_to @senator, notice: 'Senator Added.' }
  ...
  def destroy
    @senator.destroy
    respond_to do |format|
      format.html { redirect_to senators_url, notice: 'senator was successfully impeached.' }
  ...
  private
    ...
    def senator_params
      params.require(:senator).permit(:full_name, :born, :telephone)
    end
end
