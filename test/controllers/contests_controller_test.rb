...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { code: @contest.code, contestType: @contest.contestType, location_type: @contest.location_type, name: @contest.name }
    end
  ...
  test "should update contest" do
    patch :update, id: @contest, contest: { code: @contest.code, contestType: @contest.contestType, location_type: @contest.location_type, name: @contest.name }
    assert_redirected_to contest_path(assigns(:contest))
  end
