...
class PoliticiansControllerTest < ActionController::TestCase
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post :create, politician: { born: @politician.born, full_name: @politician.full_name, telephone: @politician.telephone }
    end
  ...
  test "should update politician" do
    patch :update, id: @politician, politician: { born: @politician.born, full_name: @politician.full_name, telephone: @politician.telephone }
    assert_redirected_to politician_path(assigns(:politician))
  end
